...
import type { LeaderboardWindowRef } from "./components/LeaderboardWindow";

const Portfolio: React.FC = () => {
  const { openWindows, openWindow, closeWindow, bringToFront, toggleMinimize } =
    useWindowManager();
